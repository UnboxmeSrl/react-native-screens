...
declare module 'react-native-screens' {
  ...
  export interface ScreenProps extends ViewProps {
    ...
    /**
     * @description When set to true the back swipe native gesture will be enabled when the parent Screen is on top of the stack. The default value is false.
     */
    nativeBackGesture?: boolean;
    /**
